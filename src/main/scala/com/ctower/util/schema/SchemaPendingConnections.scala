...
object SchemaPendingConnections {
  ...
  def getEligibleTrackSchema(sc:SparkContext): StructType = {
    val eligibleTrack_schema = StructType(
		...
		StructField("ckpi2", StringType, true),
  ...
  def getnotconnectmmfSchema(sc:SparkContext): StructType = {
		...
		List(
		StructField("CREGION", StringType, true),
		StructField("CAWBNO", StringType, true),
		StructField("DINSCANDT", StringType, true),
		StructField("CORGINLOC", StringType, true),
		StructField("CPRODCODE", StringType, true),
		...
		StructField("CD16", StringType, true),
		StructField("CD17", StringType, true),
		StructField("CD18", StringType, true),
		StructField("CD19", StringType, true),
		StructField("CD20", StringType, true),
		StructField("CD21", StringType, true),
		StructField("CD22", StringType, true),
		StructField("CD23", StringType, true),
		StructField("CD24", StringType, true),
		StructField("CD25", StringType, true),
		StructField("CD26", StringType, true),
		StructField("CD27", StringType, true),
		StructField("CD28", StringType, true),
		StructField("CD29", StringType, true),
		StructField("CD30", StringType, true),
		StructField("CCURLOC", StringType, true),
		StructField("DCURLOC", StringType, true),
		StructField("CNXTLOC", StringType, true),
		StructField("DNXTLOC", StringType, true),
		StructField("CNXTLOCSTR", StringType, true)
		))
...
def getawbmstSchema(sc:SparkContext): StructType = {
  ...
  def getlocationtrackerSchema(sc:SparkContext): StructType = {
    val locationtrackerSchema = StructType(
    List(
    ...
    return locationtrackerSchema
  }
  
  def getdelsheetSchema(sc:SparkContext): StructType = {
    val delsheetSchema = StructType(
    List(
		StructField("ddate", StringType, true),
		StructField("ddeliverydt", StringType, true),
		StructField("cstatcode", StringType, true),
		StructField("cawbno", StringType, true),
		StructField("cloccode", StringType, true),
		StructField("cemplcode", StringType, true),
		StructField("cstattime", StringType, true),
		StructField("nsrno", StringType, true),
		StructField("load_ts", TimestampType, true)
	))
  ...
  def getshipfltmstSchema(sc:SparkContext): StructType = {
    val shipfltmstSchema = StructType(
    List(
	StructField("dstatdate", StringType, true),
	StructField("cawbno", StringType, true),
	StructField("cloccode", StringType, true),
